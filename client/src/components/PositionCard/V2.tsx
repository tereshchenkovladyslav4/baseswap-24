import { CurrencyAmount, Percent, Token } from '@baseswapfi/sdk-core'
...
import { BIG_INT_ZERO } from 'config/constants/v3'
import { useTokenBalance } from 'lib/hooks/useCurrencyBalance'

const StyledPositionCard = styled(LightCard)<{ bgColor: any }>`
  border: none;
  background: ${({ theme, bgColor }) =>
    `radial-gradient(91.85% 100% at 1.84% 0%, ${transparentize(0.8, bgColor)} 0%, ${
      theme.colors.gradients.basedsexgrayflip
    } 100%) `};
  position: relative;
  overflow: hidden;
`
          ...
          <AutoColumn gap="sm">
            ...
            {userDefaultPoolBalance && JSBI.greaterThan(userDefaultPoolBalance.quotient, BIG_INT_ZERO) && (
              <RowBetween marginTop="10px">
                <Button padding="8px" as={Link} to={`/migrate/v2/${pair.liquidityToken.address}`} width="64%">
                  <Trans>Migrate</Trans>
                </Button>
                <Button
                  padding="8px"
