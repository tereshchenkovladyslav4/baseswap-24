...
import { IMetric, MetricLoggerUnit, setGlobalMetric } from '@baseswapfi/smart-order-router'
import { AVERAGE_L1_BLOCK_TIME } from 'config/constants/chainInfo'
...
export function useRoutingAPITrade<TTradeType extends TradeType>(
  ...
  // End game is getQuote function using alpha router
