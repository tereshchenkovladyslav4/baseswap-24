...
import type { NonfungiblePositionManager, NonfungiblePositionManagerInterface } from '../NonfungiblePositionManager'
...
export class NonfungiblePositionManager__factory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(_factory, _WETH9, _tokenDescriptor_, overrides || {}) as Promise<NonfungiblePositionManager>
  }
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): NonfungiblePositionManager {
    return new Contract(address, _abi, signerOrProvider) as NonfungiblePositionManager
  }
}
