...
export class UniswapInterfaceMulticall__factory extends ContractFactory {
  ...
  deploy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<UniswapInterfaceMulticall> {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): UniswapInterfaceMulticall {
    return new Contract(address, _abi, signerOrProvider) as UniswapInterfaceMulticall
  }
}
