...
interface UniversalRouterInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'collectRewards', values: [BytesLike]): string
...
export class UniversalRouter extends BaseContract {
  ...
  callStatic: {
    collectRewards(looksRareClaim: BytesLike, overrides?: CallOverrides): Promise<void>

    'execute(bytes,bytes[])'(commands: BytesLike, inputs: BytesLike[], overrides?: CallOverrides): Promise<void>
  ...
  filters: {
    RewardsSent(amount?: null): TypedEventFilter<[BigNumber], { amount: BigNumber }>
  }
