...
export class IUniswapV3Staker extends BaseContract {
  ...
  rewards(rewardToken: string, owner: string, overrides?: CallOverrides): Promise<BigNumber>
  ...
  estimateGas: {
    ...
    deposits(tokenId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>
    ...
    incentives(incentiveId: BytesLike, overrides?: CallOverrides): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    deposits(tokenId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>
    ...
    incentives(incentiveId: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>
    ...
    rewards(rewardToken: string, owner: string, overrides?: CallOverrides): Promise<PopulatedTransaction>
